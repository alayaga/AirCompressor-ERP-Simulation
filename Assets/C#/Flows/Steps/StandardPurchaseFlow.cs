...
/// <summary>
/// 标准产品原料采购流程
/// 从PMC制作采购计划到采购入库的完整流程
/// </summary>
public class StandardPurchaseFlow : FlowBase
{
    /// <summary>
    /// 步骤信息结构
    /// </summary>
    ...
    // 流程信息
    private const string FLOW_NAME = "标准产品原料采购流程";
    private const string TASK_TITLE = "原料采购流程";
    private const string TASK_DESCRIPTION = "完成从PMC采购计划到采购入库的完整流程";
